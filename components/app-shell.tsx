    ...
    <CurrencyProvider currency={currency}>
      ...
      >
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header
            className="sticky top-0 z-10 flex h-16 shrink-0 items-center justify-between border-b border-[var(--border-raw)] bg-[var(--header-bg)] px-4 backdrop-blur-xl sm:px-6 lg:px-9"
          >
            <div className="min-w-0">
              <div className="text-[10px] uppercase tracking-[0.14em] text-[var(--text-3)]">
                FINANCE_OS
              </div>
              <div className="truncate text-[13px] font-semibold uppercase tracking-[0.08em] text-[var(--text-0)]">
                {crumb}
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="hidden text-right text-[10px] uppercase tracking-[0.12em] text-[var(--text-2)] sm:block">
          ...
          <main className="min-h-0 flex-1 overflow-auto px-4 pb-16 pt-6 sm:px-6 lg:px-9">
            {children}
          </main>
        </div>
      </div>
